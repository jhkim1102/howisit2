...
import com.howisit.dto.OrderDto;
import com.howisit.dto.OrderHistDto;
import com.howisit.dto.OrderItemDto;
...
import com.howisit.respository.OrderRepository;
...
public class OrderService {
	...
	public Long order(OrderDto orderDto, String email) {
		...
		//4.회원 정보와 주문할 상품 정보를 이용하여 주문 엔티티를 결정
	...
	public Page<OrderHistDto> getOrderList(String email, Pageable pageable) {
		//1.유저 아이디와 페이징 조건을 이용하여 주문목록을 조회
	...
	public void cancelOrder(Long orderId) {
		Order order = orderRepository.findById(orderId)
									 .orElseThrow(EntityNotFoundException::new);
		//OrderStatus를 update -> entity 의 필드값을 바꿔주면 된다.
		order.cancelOrder();
	}
	...
	public void deleteOrder(Long orderId) {
		...
		//->영속성 컨테스트에 엔티티를 저장한 후 변경 감지를 하기 위해
		Order order = orderRepository.findById(orderId)
									 .orElseThrow(EntityNotFoundException::new);
